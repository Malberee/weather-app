export const SunnyCloudy = ({ width = 250 }) => (
	<svg
		width={width}
		// height="328"
		viewBox="0 0 404 328"
	...
	>
		...
		<circle
			...
			cy="107"
			r="58"
			fill="url(#paint0_linear_102_310)"
			stroke="url(#paint1_linear_102_310)"
			strokeWidth="2"
		/>
		<mask
			id="mask0_102_310"
		...
		>
			<path
				...
				fill="url(#paint2_linear_102_310)"
			/>
		</mask>
		<g mask="url(#mask0_102_310)">
			<g filter="url(#filter1_f_102_310)">
				<path
					fillRule="evenodd"
					clipRule="evenodd"
		...
		<g filter="url(#filter2_bd_102_310)">
			<mask id="path-5-inside-1_102_310" fill="white">
				<path
					fillRule="evenodd"
					clipRule="evenodd"
			...
			<path
				...
				clipRule="evenodd"
				d="M265.5 262.997C265.666 262.999 265.833 263 266 263C289.748 263 309 243.748 309 220C309 196.252 289.748 177 266 177C265.833 177 265.666 177.001 265.5 177.003V177H254.391C254.793 174.057 255 171.053 255 168C255 131.549 225.451 102 189 102C152.549 102 123 131.549 123 168C123 171.439 123.263 174.817 123.77 178.115C120.631 177.386 117.361 177 114 177C90.2518 177 71 196.252 71 220C71 243.748 90.2518 263 114 263C114.168 263 114.335 262.999 114.502 262.997L114.5 263H265.5V262.997Z"
				fill="url(#paint3_linear_102_310)"
			...
			<path
				...
				fill="url(#paint4_linear_102_310)"
				mask="url(#path-5-inside-1_102_310)"
			/>
		</g>
		<g filter="url(#filter3_bd_102_310)">
			<mask id="path-7-inside-2_102_310" fill="white">
				<path
					fillRule="evenodd"
					clipRule="evenodd"
			...
			<path
				...
				clipRule="evenodd"
				d="M343.563 218.351C343.683 218.352 343.804 218.353 343.924 218.353C361.087 218.353 375 204.44 375 187.277C375 170.115 361.087 156.202 343.924 156.202C343.804 156.202 343.683 156.202 343.563 156.204V156.202H335.535C335.825 154.075 335.975 151.904 335.975 149.697C335.975 123.355 314.62 102 288.277 102C261.935 102 240.58 123.355 240.58 149.697C240.58 152.183 240.77 154.624 241.136 157.007C238.868 156.48 236.504 156.202 234.076 156.202C216.913 156.202 203 170.115 203 187.277C203 204.44 216.913 218.353 234.076 218.353C234.197 218.353 234.318 218.352 234.439 218.351L234.437 218.353H343.563V218.351Z"
				fill="url(#paint5_linear_102_310)"
				shapeRendering="crispEdges"
			/>
			<path
				...
				fill="url(#paint6_linear_102_310)"
				mask="url(#path-7-inside-2_102_310)"
			/>
		</g>
		<defs>
			<filter
				id="filter0_f_102_310"
				x="139"
				y="0"
				width="210"
				height="210"
			...
			>
				...
				<feGaussianBlur
					stdDeviation="22"
					result="effect1_foregroundBlur_102_310"
				/>
			</filter>
			<filter
				id="filter1_f_102_310"
				x="82"
				y="81"
				width="266"
				height="191"
			...
			>
				...
				<feComposite
					in2="SourceAlpha"
					operator="in"
					result="effect1_backgroundBlur_102_310"
				/>
				<feColorMatrix
					in="SourceAlpha"
					type="matrix"
				...
				<feBlend
					mode="normal"
					in2="effect1_backgroundBlur_102_310"
					result="effect2_dropShadow_102_310"
				/>
				<feBlend
					mode="normal"
					in="SourceGraphic"
					in2="effect2_dropShadow_102_310"
					result="shape"
				/>
			</filter>
			<filter
				id="filter3_bd_102_310"
				x="132"
				y="67"
				width="272"
				height="216.353"
